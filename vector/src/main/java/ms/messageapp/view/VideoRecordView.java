...
public class VideoRecordView extends RelativeLayout {
    ...
    private void initView() {
        View.inflate(getContext(), ms.messageapp.R.layout.video_record_view, this);

        // retrieve the UI items
        mVideoRecordProgressView = findViewById(ms.messageapp.R.id.video_record_progress_view);
    }
